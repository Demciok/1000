...
test_turn_must_follow_suit = Turn(
    1,
    {
        1: Card("karo", "K", 4, "dzwonek"),
        2: Card("karo", "10", 10, "dzwonek")
    },
    "karo",
    None
)
...
# botu brakuje 2 rzeczy takiej tatyki co rzucic gdy moze, 
# reki kart ktorej moze rzucic to by bardzo ulatwilo wybieranie 
# bot nie patrzy na kolor ktory jest podany jako wiodacy tylko czasami rzuca co chce